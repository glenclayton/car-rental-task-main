...
public class CarRentalTest {
    ...
    public void initCars() {
        CAR1 = new Car("VW", "Golf", "XX11 1UR", "B2", 90);
        CAR2 = new Car("VW", "Passat", "XX12 2UR",  "C1", 110);
        CAR3 = new Car("VW", "Polo", "XX13 3UR",  "A1", 65);
        CAR4 = new Car("VW", "Polo", "XX14 4UR",  "A1", 70);
    }
    ...
    @Test
    public void testCanRentCarWithNoRentals() {
        DatePeriod dp1 = new DatePeriod(LocalDate.of(2023, 01, 15), LocalDate.of(2023, 01, 20)); 
        Rental rental = new Rental(RENTER1,dp1);
        CarRentalCompany carRentalCompany = new CarRentalCompany();
        boolean rv = carRentalCompany.rentCar(RENTER1, CAR1, dp1);
        assertThat(rv).isTrue();
        assertThat(carRentalCompany.getRentedCars().size()).isEqualTo(1); 
    }

    @Test
    public void testCanRentCarWithNonOverlappingRental() {
        DatePeriod dp1 = new DatePeriod(LocalDate.of(2023, 01, 15), LocalDate.of(2023, 01, 20)); 
        CarRentalCompany carRentalCompany = new CarRentalCompany();
        boolean rv = carRentalCompany.rentCar(RENTER1, CAR1, dp1);
        assertThat(rv).isTrue();
    ...
    @Test
    public void testCannotRentCarWitOverlappingRental() {
        DatePeriod dp1 = new DatePeriod(LocalDate.of(2023, 01, 15), LocalDate.of(2023, 01, 20)); 
        CarRentalCompany carRentalCompany = new CarRentalCompany();
        boolean rv = carRentalCompany.rentCar(RENTER1, CAR1, dp1);
        assertThat(rv).isTrue();
        assertThat(carRentalCompany.getRentedCars().size()).isEqualTo(1); 
        DatePeriod dp2 = new DatePeriod(LocalDate.of(2023, 01, 17), LocalDate.of(2023, 01, 22)); 
        rv = carRentalCompany.rentCar(RENTER2, CAR1, dp2);
